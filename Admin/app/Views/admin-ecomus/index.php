                    ...
                    <div class="main-content">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="dropdown default style-box">
                                                <button class="btn btn-secondary dropdown-toggle" type="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                                    <a href="product-list.html" class="view-all">Yearly<i
                                            ...
                                            <ul class="flex flex-column h-full has-divider-line">
                                                ...
                                                <li class="wg-product">
                                                    <div class="name flex-grow">
                                                        ...
                                                        <div>
                                                            <div class="title">
                                                                <a href="#" class="body-text">Oversized Motif
                                                                    T-shirt</a>
                                                            </div>
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 <a
                                    href="https://themesflat.co/html/ecomus/index.html">Ecomus</a>. Design by Themesflat
